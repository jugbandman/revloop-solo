...
### `--light` (5 min)
- Pylon ticket scan
- Recent transcript pull from `10-Customers/<name>/transcripts/`
...
## Sensitive data
All levels respect sensitive-data routing. If the customer file has `#sensitive` or content lives under `10-Customers/<name>/sensitive/`, that content goes through the OpenAI adapter per the Sensitive Data Routing doctrine in CLAUDE.md.

## Outputs
- `10-Customers/<name>/research/YYYY-MM-DD-<level>.md`
