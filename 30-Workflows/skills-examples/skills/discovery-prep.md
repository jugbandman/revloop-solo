...
- Read `60-Context/icp.md` and `60-Context/personas.md` for qualification criteria
- Read `60-Context/brand-voice.md` for your voice rules
...
1. Check if entity folder exists: `80-Pipeline/prospects/{company}/` or `80-Pipeline/deals/{company}/`
2. If `context.md` exists, read it for prior interactions
3. Check `70-Meetings/` for any previous call notes with this company
...
Based on the prospect's profile, competitive landscape, and `60-Context/competitive.md` (if exists):
...
- `80-Pipeline/prospects/{company}/call-prep-YYYY-MM-DD.md` or `80-Pipeline/deals/{company}/call-prep-YYYY-MM-DD.md`

## Voice Rules

- All client-facing content follows your voice (warm, consultative, no em-dashes, see `60-Context/brand-voice.md`)
