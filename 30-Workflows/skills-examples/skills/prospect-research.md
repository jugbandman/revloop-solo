...
- Read `60-Context/icp.md` and `60-Context/personas.md` for targeting criteria
...
- Read `80-Pipeline/deals/` for active deals
- Read `80-Pipeline/prospects/` for prospects already being tracked
- Read `80-Pipeline/leads/` for inbound leads not yet qualified
...
Based on `60-Context/icp.md`, confirm the target segment:
...
- `80-Pipeline/prospects/{company}/context.md` with company profile, contacts, signals, and ICP fit score
...
Save the prioritized list to `00-Inbox/scratch/prospect-list-YYYY-MM-DD.md` with:
...
Update each entity's `80-Pipeline/prospects/{company}/context.md` with enrichment data.
...
- Any prospect-facing output follows your voice (no em-dashes, warm, professional, see `60-Context/brand-voice.md`)
