...
- `obsidian-cli` installed (path in `90-System/system-docs/user.md`)
...
- **Orphaned files**: files with no incoming links. Always filter out `30-Workflows/skills-examples/` (contains node_modules, tens of thousands of files), `90-System/templates/`, `90-System/system-docs/`, and `.obsidian/`. Report only orphans in `80-Pipeline/`, `00-Inbox/scratch/`, `70-Meetings/`, `20-People/`, `50-Knowledge/`, `++Home/`.
...
**Vault health:** 1 broken link in 80-Pipeline/deals/acme-corp/context.md
**Orphaned files:** 00-Inbox/scratch/pipeline-analysis/old-notes.md (consider archiving)
