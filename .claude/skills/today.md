...
- Read _system/health.md for any overdue automations
- If team mode: read _system/contributors.md, identify current user via git user.name

### 2. Scan Pipeline
- Check pipeline/ (or c-gtm/pipeline/) for active deals and prospects
...
### 3. Check Meetings
- Scan meetings/ (or o-transcripts/) for recent meetings that may need follow-up
- Check for unprocessed transcripts in _imports/

### 4. Check Deliverables
- Scan scratch/ (or c-workspace/) for draft deliverables that need finishing
- Check for recently created items that may need follow-up

### 5. Check Automation Health
- Read _system/health.md automation status table
...
- "Process transcript in _imports/ > /process-transcript"
