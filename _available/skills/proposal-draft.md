...
- Read `context/brand-voice.md` for the founder's voice rules (see CLIENT.md)
- Read `context/offerings.md` for available products/services
- Read `_templates/proposal-template.md` if it exists
...
- `pipeline/deals/{company}/context.md` for relationship history
- `pipeline/deals/{company}/debrief-*.md` for call notes
- `meetings/` for relevant meeting transcripts
...
- `pipeline/deals/{company}/proposal-YYYY-MM-DD.md`
- Update `pipeline/deals/{company}/context.md` with proposal status
