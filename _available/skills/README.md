...
```bash
mv _available/skills/{skill-name}.md .claude/skills/{skill-name}.md
```
...
Skills reference paths like `pipeline/deals/{slug}/` and `context/icp.md`. These match the revloop-solo vault structure. If your folder names differ, do a search-and-replace in the skill file before installing.
