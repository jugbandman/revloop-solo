...
- Read `context/brand-voice.md` for the founder's voice rules
- Read `context/icp.md` and `context/personas.md` for targeting alignment
...
1. Check if `pipeline/prospects/{company}/context.md` or `pipeline/deals/{company}/context.md` exists. Read it.
...
- `pipeline/prospects/{company}/outreach-sequence-YYYY-MM-DD.md`
- Or `pipeline/deals/{company}/outreach-sequence-YYYY-MM-DD.md`
