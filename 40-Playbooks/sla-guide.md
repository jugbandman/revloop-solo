...
1. Read all `10-Customers/*/action-items.md` via Dataview-equivalent query
...
6. Add `## Customer touches due today` from `10-Customers/*/profile.md` where `next_meeting == today`
