...
**Quick:** Drop files in `00-Inbox/` and run `/import-context`. It will route them to the right category.
...
The **sales-coach** agent reads `50-Knowledge/frameworks/` and `40-Playbooks/` when coaching you on deals, business cases, and messaging. The more context you give it, the better the coaching.

The **/meeting-prep** skill checks `50-Knowledge/` for relevant frameworks when building your prep brief.
