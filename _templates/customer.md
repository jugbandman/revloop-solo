...
Customer entity scaffold. Each customer is a directory at customers/<customer-name>/ with a profile, transcripts, emails, slack-saves, and action-items file. This template documents the folder shape and the per-file frontmatter.

# Customer Entity Scaffold

Each customer is a directory at `customers/<customer-name>/` with this shape:
...
## profile.md template (place at customers/<customer-name>/profile.md)
...
## action-items.md template (place at customers/<customer-name>/action-items.md)
