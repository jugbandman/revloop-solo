...
- Obsidian-specific instructions (plugin setup, CLI usage) are documented in `90-System/system-docs/OBSIDIAN-DEPS.md` as optional enhancers, not in the main README
...
- GitHub setup is optional, not part of the onboarding flow
